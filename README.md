...
- Personal playbook (how to use signals): [`docs/PERSONAL_PLAYBOOK.md`](docs/PERSONAL_PLAYBOOK.md)
- Runbook (maintenance/failures): [`docs/RUNBOOK.md`](docs/RUNBOOK.md)
- Launch checklist: [`docs/LAUNCH_CHECKLIST.md`](docs/LAUNCH_CHECKLIST.md)
- Launch v1: [`docs/LAUNCH_V1.md`](docs/LAUNCH_V1.md)
